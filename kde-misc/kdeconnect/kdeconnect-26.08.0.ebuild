...
SRC_URI="https://download.kde.org/stable//release-service/26.08.0/src/kdeconnect-kde-26.08.0.tar.xz -> kdeconnect-kde-26.08.0.tar.xz"
...
"
S="${WORKDIR}/kdeconnect-kde-26.08.0"
src_prepare() {
	cmake_src_prepare
}
src_configure() {
