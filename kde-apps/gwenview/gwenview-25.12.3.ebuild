...
SRC_URI="https://download.kde.org/stable/release-service/25.12.3/src/gwenview-25.12.3.tar.xz -> gwenview-25.12.3.tar.xz"
SLOT="6"
KEYWORDS="*"
IUSE="activities fits +mpris raw semantic-desktop share X wayland"
BDEPEND="wayland? (
	  dev-util/wayland-scanner
	)
	
"
RDEPEND="virtual/kde-seed[gui,multimedia,svg,wayland?,X?]
