...
SRC_URI="https://download.kde.org/stable/release-service/25.12.1/src/korganizer-25.12.1.tar.xz -> korganizer-25.12.1.tar.xz"
SLOT="6"
KEYWORDS="*"
IUSE="activities telemetry"
RESTRICT="test"
RDEPEND="!<kde-apps/kdepim-addons-24.07.50:*
