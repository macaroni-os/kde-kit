...
SRC_URI="https://download.kde.org/stable/release-service/25.12.1/src/kdepim-runtime-25.12.1.tar.xz -> kdepim-runtime-25.12.1.tar.xz"
SLOT="6"
KEYWORDS="*"
IUSE="activities speech"
RESTRICT="test"
RDEPEND=">=app-crypt/qca-2.3.7:2[qt6(+)]
