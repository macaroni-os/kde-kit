...
SRC_URI="https://download.kde.org/stable/release-service/25.12.1/src/kio-extras-25.12.1.tar.xz -> kio-extras-25.12.1.tar.xz"
SLOT="6"
KEYWORDS="*"
...
"
RDEPEND="!kde-apps/kio-extras:5[-kf6compat(-)]
