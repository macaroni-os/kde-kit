...
SRC_URI="https://download.kde.org/stable/plasma/6.5.6/plasma-desktop-6.5.6.tar.xz -> plasma-desktop-6.5.6.tar.xz"
SLOT="6"
KEYWORDS="*"
...
RDEPEND="virtual/kde-seed[declarative,gui,sql,wayland?]
	...
	webengine? ( >=net-libs/signon-oauth2-0.25_p20210102 )
