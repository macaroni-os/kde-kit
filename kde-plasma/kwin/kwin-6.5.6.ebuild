...
SRC_URI="https://download.kde.org/stable/plasma/6.5.6/kwin-6.5.6.tar.xz -> kwin-6.5.6.tar.xz"
SLOT="6"
KEYWORDS="*"
PATCHES=(
...
"
RDEPEND="virtual/kde-seed[declarative,svg,gui,X,wayland,gles2-only?]
	dev-libs/libei
	dev-libs/libinput:=
